...
if package == 'Platinum':print('$',str(60))
if package == 'Gold': print('$', str(50))
if package == 'Silver':print('$', str(40))
if package == 'Bronze':print('$', str(30))
if package == 'Free Trial': print('Free')
